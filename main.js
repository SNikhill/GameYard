...
function nxtvideo(){
  ...
  if(count==1){
    ...
    j.src= "Videos/Creed.mp4";
  }

  if(count==2){
    h.style.backgroundImage= "url('Images/BlackOps.jpg')";
    i.innerHTML="Black Ops";
    j.src= "Videos/BlackOps.mp4";
  }
/*
  if(count==3){
    h.style.backgroundImage= "url('Images/Creed.jpg')";
  ...
  if(count==3){
    h.style.backgroundImage= "url('Images/Hitman.jpg')";
    i.innerHTML="Hitman 2";
    j.src= "Videos/Hitman2.mp4";
    count=0;
  }
...
function changeimg(){
      ...
      setTimeout(function(){
       a.style.backgroundImage="url('Imggallery/Halo5.jpg')";
       b.innerHTML="Halo 5";
      },3000);
      setTimeout(function(){
      a.style.backgroundImage="url('Imggallery/BattleField4.jpg')";
      b.innerHTML="BattleField 4"; b.style.color= "black"
      },6000);
      setTimeout(function(){
      a.style.backgroundImage="url('Imggallery/DevilMayCry.jpg')";
      b.innerHTML="Devil May Cry"; b.style.color= "black";
      },9000);
      setTimeout(function(){
      a.style.backgroundImage="url('Imggallery/TheWitcher.jpg')";
      b.innerHTML="The Witcher";
      },12000);
      setTimeout(function(){
      a.style.backgroundImage="url('Imggallery/Dota2.jpg')";
      b.innerHTML="Dota 2"; b.style.color= "white";
      mousecount=0;
      changeimg();
      },15000);
    }
